...
//        mTextButton = findViewById(R.id.button_text);
    ...
    private void runFaceContourDetection() {
        Log.d("bitmap::",mSelectedImage.toString());
    ...
    public void onItemSelected(AdapterView<?> parent, View v, int position, long id) {
        ...
        switch (position) {
            case 0:
//                    mSelectedImage = getBitmapFromAsset(this, (ImageView)findViewById(R.id.image_view));
...
//                    imgbt.setImageBitmap(selectedImage);
                    ...
                    imgbt.setImageURI(selectedImageUri);
//                    ImageView((ImageView) findViewById(R.id.image_view)).setImageURI(selectedImageUri);
                }
            }
        } catch (Exception e) {
