...
//    canvas.drawRect(left, top, right, bottom, boxPaint);
    ...
    Log.d("landmarkdata:",face.getAllLandmarks().toString());
    for (FaceContour faceContour : contour) {

      Log.d("faceContourData:", String.valueOf(faceContour.getFaceContourType()));
      if( faceContour.getFaceContourType()==6/* left eye*/ || faceContour.getFaceContourType()==7 /* right eye*/){
    ...
    if (leftEye != null) {
      Log.d("lefteyeData:",leftEye.toString());
      canvas.drawCircle(
    ...
    if (rightEye != null) {
      Log.d("righteyeData:",rightEye.toString());
      canvas.drawCircle(
